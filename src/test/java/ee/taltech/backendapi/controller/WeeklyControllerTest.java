...
class WeeklyControllerTest {
    ...
    @Test
    void weeklyCryptoController1Week() throws Exception {
        Mockito.when(alphaVantageApi.query("DIGITAL_CURRENCY_WEEKLY", "Time Series (Digital Currency Weekly)")).thenReturn(
                List.of(
                        new DataPoint(LocalDate.of(2021, 5, 7), new BigDecimal(54), new BigDecimal(106))
                )
        );
    ...
    @Test
    void weeklyCryptoController3Weeks() throws Exception {
        Mockito.when(alphaVantageApi.query("DIGITAL_CURRENCY_WEEKLY", "Time Series (Digital Currency Weekly)")).thenReturn(
                List.of(
                        new DataPoint(LocalDate.of(2021, 5, 7), new BigDecimal(5000), new BigDecimal(10000)),
                        new DataPoint(LocalDate.of(2021, 5, 14), new BigDecimal(150), new BigDecimal(1000)),
                        new DataPoint(LocalDate.of(2021, 5, 21), new BigDecimal(10), new BigDecimal(50))
                )
        );
